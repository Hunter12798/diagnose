...
function hipogastrikağrı(){
  ...
  if(hipogastrikağrıCheckbox.checked){
    for (var i = 0; i < hipogastrikağrı.length; i++) {
      hipogastrikağrı[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < hipogastrikağrı.length; i++) {
      hipogastrikağrı[i].style.color = "black";
    }
  }
}
function aldosterondüşüklüğü() {
  ...
  if (aldosterondüşüklüğüCheckbox.checked) {
    for (var i = 0; i < aldosterondüşüklüğü.length; i++) {
      aldosterondüşüklüğü[i].style.color = "maroon";
    }
  } else {
    for (var i = 0; i < aldosterondüşüklüğü.length; i++) {
      aldosterondüşüklüğü[i].style.color = "black";
    }
  }
}
function hipokalemi() {
  let hipokalemi = document.getElementsByClassName("hipokalemi");
  let hipokalemiCheckbox = document.getElementById("hipokalemi");
  if (hipokalemiCheckbox.checked) {
    for (let i = 0; i < hipokalemi.length; i++) {
      hipokalemi[i].style.color = "maroon";
    }
  } else {
    for (let i = 0; i < hipokalemi.length; i++) {
      hipokalemi[i].style.color = "black";
    }
  }
}
function hiperkalemi() {
  let hiperkalemi = document.getElementsByClassName("hiperkalemi");
  let hiperkalemiCheckbox = document.getElementById("hiperkalemi");
  if (hiperkalemiCheckbox.checked) {
    for (let i = 0; i < hiperkalemi.length; i++) {
      hiperkalemi[i].style.color = "maroon";
    }
  } else {
    for (let i = 0; i < hiperkalemi.length; i++) {
      hiperkalemi[i].style.color = "black";
    }
  }
}
function metabolikalkaloz() {
  let metabolikalkaloz = document.getElementsByClassName("metabolikalkaloz");
  let metabolikalkalozCheckbox = document.getElementById("metabolikalkaloz");
  if (metabolikalkalozCheckbox.checked) {
    for (let i = 0; i < metabolikalkaloz.length; i++) {
      metabolikalkaloz[i].style.color = "maroon";
    }
  } else {
    for (let i = 0; i < metabolikalkaloz.length; i++) {
      metabolikalkaloz[i].style.color = "black";
    }
  }
}
function metabolikasidoz() {
  let metabolikasidoz = document.getElementsByClassName("metabolikasidoz");
  let metabolikasidozCheckbox = document.getElementById("metabolikasidoz");
  if (metabolikasidozCheckbox.checked) {
    for (let i = 0; i < metabolikasidoz.length; i++) {
      metabolikasidoz[i].style.color = "maroon";
    }
  } else {
    for (let i = 0; i < metabolikasidoz.length; i++) {
      metabolikasidoz[i].style.color = "black";
    }
  }
}
function reninyüksekliği(){
  let reninyüksekliği = document.getElementsByClassName("reninyüksekliği");
  let reninyüksekliğiCheckbox = document.getElementById("reninyüksekliği");
  if (reninyüksekliğiCheckbox.checked) {
    for (let i = 0; i < reninyüksekliği.length; i++) {
      reninyüksekliği[i].style.color = "maroon";
    }
  } else {
    for (let i = 0; i < reninyüksekliği.length; i++) {
      reninyüksekliği[i].style.color = "black";
    }
  }
}

function aldosteronyüksekliği(){
  let aldosteronyüksekliği = document.getElementsByClassName("aldosteronyüksekliği");
  let aldosteronyüksekliğiCheckbox = document.getElementById("aldosteronyüksekliği");
  if (aldosteronyüksekliğiCheckbox.checked) {
    for (let i = 0; i < aldosteronyüksekliği.length; i++) {
      aldosteronyüksekliği[i].style.color = "maroon";
    }
  } else {
    for (let i = 0; i < aldosteronyüksekliği.length; i++) {
      aldosteronyüksekliği[i].style.color = "black";
    }
  }
}

function normotansiyon(){
  let normotansiyon = document.getElementsByClassName("normotansiyon");
  let normotansiyonCheckbox = document.getElementById("normotansiyon");
  if (normotansiyonCheckbox.checked) {
    for (let i = 0; i < normotansiyon.length; i++) {
      normotansiyon[i].style.color = "maroon";
    }
  } else {
    for (let i = 0; i < normotansiyon.length; i++) {
      normotansiyon[i].style.color = "black";
    }
  }
}

function hipomagnezemi(){
  let hipomagnezemi = document.getElementsByClassName("hipomagnezemi");
  let hipomagnezemiCheckbox = document.getElementById("hipomagnezemi");
  if (hipomagnezemiCheckbox.checked) {
    for (let i = 0; i < hipomagnezemi.length; i++) {
      hipomagnezemi[i].style.color = "maroon";
    }
  } else {
    for (let i = 0; i < hipomagnezemi.length; i++) {
      hipomagnezemi[i].style.color = "black";
    }
  }
}
function renalyetmezlik(){
  let renalyetmezlik = document.getElementsByClassName("renalyetmezlik");
  let renalyetmezlikCheckbox = document.getElementById("renalyetmezlik");
  if (renalyetmezlikCheckbox.checked) {
    for (let i = 0; i < renalyetmezlik.length; i++) {
      renalyetmezlik[i].style.color = "maroon";
    }
  } else {
    for (let i = 0; i < renalyetmezlik.length; i++) {
      renalyetmezlik[i].style.color = "black";
    }
  }
}
function trombositopeni(){
  let trombositopeni = document.getElementsByClassName("trombositopeni");
  let trombositopeniCheckbox = document.getElementById("trombositopeni");
  if (trombositopeniCheckbox.checked) {
    for (let i = 0; i < trombositopeni.length; i++) {
      trombositopeni[i].style.color = "maroon";
    }
  } else {
    for (let i = 0; i < trombositopeni.length; i++) {
      trombositopeni[i].style.color = "black";
    }
  }
}

function hipokalsiüri(){
  let hipokalsiüri = document.getElementsByClassName("hipokalsiüri");
  let hipokalsiüriCheckbox = document.getElementById("hipokalsiüri");
  if (hipokalsiüriCheckbox.checked) {
    for (let i = 0; i < hipokalsiüri.length; i++) {
      hipokalsiüri[i].style.color = "maroon";
    }
  } else {
    for (let i = 0; i < hipokalsiüri.length; i++) {
      hipokalsiüri[i].style.color = "black";
    }
  }
}
...
function büyümegeriliği(){
  ...
  if (büyümegeriliğiCheckbox.checked) {
    for (let i = 0; i < büyümegeriliği.length; i++) {
...
function katekolaminyüksekliği() {
  let katekolaminyüksekliği = document.getElementsByClassName("katekolaminyüksekliği");
  let katekolaminyüksekliğiCheckbox = document.getElementById("katekolaminyüksekliği");
  if (katekolaminyüksekliğiCheckbox.checked) {
    for (var i = 0; i < katekolaminyüksekliği.length; i++) {
      katekolaminyüksekliği[i].style.color = "maroon";
    }
  } else {
    for (var i = 0; i < katekolaminyüksekliği.length; i++) {
      katekolaminyüksekliği[i].style.color = "black";
    }
  }
}
function kabus(){
  let kabus = document.getElementsByClassName("kabus");
  let kabusCheckbox = document.getElementById("kabus");
  if(kabusCheckbox.checked){
    for (var i = 0; i < kabus.length; i++) {
      kabus[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < kabus.length; i++) {
      kabus[i].style.color = "black";
    }
  }
}
function fonofobi(){
  let fonofobi = document.getElementsByClassName("fonofobi");
  let fonofobiCheckbox = document.getElementById("fonofobi");
  if(fonofobiCheckbox.checked){
    for (var i = 0; i < fonofobi.length; i++) {
      fonofobi[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < fonofobi.length; i++) {
      fonofobi[i].style.color = "black";
    }
  }
}
function fotofobi(){
  let fotofobi = document.getElementsByClassName("fotofobi");
  let fotofobiCheckbox = document.getElementById("fotofobi");
  if(fotofobiCheckbox.checked){
    for (var i = 0; i < fotofobi.length; i++) {
      fotofobi[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < fotofobi.length; i++) {
      fotofobi[i].style.color = "black";
    }
  }
}
function splinterhemoraji(){
  let splinterhemoraji = document.getElementsByClassName("splinterhemoraji");
  let splinterhemorajiCheckbox = document.getElementById("splinterhemoraji");
  if(splinterhemorajiCheckbox.checked){
    for (var i = 0; i < splinterhemoraji.length; i++) {
      splinterhemoraji[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < splinterhemoraji.length; i++) {
      splinterhemoraji[i].style.color = "black";
    }
  }
}
function oslernodülleri(){
  let oslernodülleri = document.getElementsByClassName("oslernodülleri");
  let oslernodülleriCheckbox = document.getElementById("oslernodülleri");
  if(oslernodülleriCheckbox.checked){
    for (var i = 0; i < oslernodülleri.length; i++) {
      oslernodülleri[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < oslernodülleri.length; i++) {
      oslernodülleri[i].style.color = "black";
    }
  }
}
function janewaylezyonları(){
  let janewaylezyonları = document.getElementsByClassName("janewaylezyonları");
  let janewaylezyonlarıCheckbox = document.getElementById("janewaylezyonları");
  if(janewaylezyonlarıCheckbox.checked){
    for (var i = 0; i < janewaylezyonları.length; i++) {
      janewaylezyonları[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < janewaylezyonları.length; i++) {
      janewaylezyonları[i].style.color = "black";
    }
  }
}
function dişgıcırdatma(){
  let dişgıcırdatma = document.getElementsByClassName("dişgıcırdatma");
  let dişgıcırdatmaCheckbox = document.getElementById("dişgıcırdatma");
  if(dişgıcırdatmaCheckbox.checked){
    for (var i = 0; i < dişgıcırdatma.length; i++) {
      dişgıcırdatma[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < dişgıcırdatma.length; i++) {
      dişgıcırdatma[i].style.color = "black";
    }
  }
}
function analbölgedekaşıntı(){
  let analbölgedekaşıntı = document.getElementsByClassName("analbölgedekaşıntı");
  let analbölgedekaşıntıCheckbox = document.getElementById("analbölgedekaşıntı");
  if(analbölgedekaşıntıCheckbox.checked){
    for (var i = 0; i < analbölgedekaşıntı.length; i++) {
      analbölgedekaşıntı[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < analbölgedekaşıntı.length; i++) {
      analbölgedekaşıntı[i].style.color = "black";
    }
  }
}
function kanlıishal(){
  let kanlıishal = document.getElementsByClassName("kanlıishal");
  let kanlıishalCheckbox = document.getElementById("kanlıishal");
  if(kanlıishalCheckbox.checked){
    for (var i = 0; i < kanlıishal.length; i++) {
      kanlıishal[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < kanlıishal.length; i++) {
      kanlıishal[i].style.color = "black";
    }
  }
}
function ptzuzaması(){
  let ptzuzaması = document.getElementsByClassName("ptzuzaması");
  let ptzuzamasıCheckbox = document.getElementById("ptzuzaması");
  if(ptzuzamasıCheckbox.checked){
    for (var i = 0; i < ptzuzaması.length; i++) {
      ptzuzaması[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < ptzuzaması.length; i++) {
      ptzuzaması[i].style.color = "black";
    }
  }
}
function hiperamonyemi(){
  let hiperamonyemi = document.getElementsByClassName("hiperamonyemi");
  let hiperamonyemiCheckbox = document.getElementById("hiperamonyemi");
  if(hiperamonyemiCheckbox.checked){
    for (var i = 0; i < hiperamonyemi.length; i++) {
      hiperamonyemi[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < hiperamonyemi.length; i++) {
      hiperamonyemi[i].style.color = "black";
    }
  }
}
function vajinalakıntı(){
  let vajinalakıntı = document.getElementsByClassName("vajinalakıntı");
  let vajinalakıntıCheckbox = document.getElementById("vajinalakıntı");
  if(vajinalakıntıCheckbox.checked){
    for (var i = 0; i < vajinalakıntı.length; i++) {
      vajinalakıntı[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < vajinalakıntı.length; i++) {
      vajinalakıntı[i].style.color = "black";
    }
  }
}
function seskısıklığı(){
  let seskısıklığı = document.getElementsByClassName("seskısıklığı");
  let seskısıklığıCheckbox = document.getElementById("seskısıklığı");
  if(seskısıklığıCheckbox.checked){
    for (var i = 0; i < seskısıklığı.length; i++) {
      seskısıklığı[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < seskısıklığı.length; i++) {
      seskısıklığı[i].style.color = "black";
    }
  }
}
function gallop(){
  let gallop = document.getElementsByClassName("gallop");
  let gallopCheckbox = document.getElementById("gallop");
  if(gallopCheckbox.checked){
    for (var i = 0; i < gallop.length; i++) {
      gallop[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < gallop.length; i++) {
      gallop[i].style.color = "black";
    }
  }
}
function pnd(){
  let pnd = document.getElementsByClassName("pnd");
  let pndCheckbox = document.getElementById("pnd");
  if(pndCheckbox.checked){
    for (var i = 0; i < pnd.length; i++) {
      pnd[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < pnd.length; i++) {
      pnd[i].style.color = "black";
    }
  }
}
function rektalprolapsus(){
  let rektalprolapsus = document.getElementsByClassName("rektalprolapsus");
  let rektalprolapsusCheckbox = document.getElementById("rektalprolapsus");
  if(rektalprolapsusCheckbox.checked){
    for (var i = 0; i < rektalprolapsus.length; i++) {
      rektalprolapsus[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < rektalprolapsus.length; i++) {
      rektalprolapsus[i].style.color = "black";
    }
  }
}
function apandisit(){
  let apandisit = document.getElementsByClassName("apandisit");
  let apandisitCheckbox = document.getElementById("apandisit");
  if(apandisitCheckbox.checked){
    for (var i = 0; i < apandisit.length; i++) {
      apandisit[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < apandisit.length; i++) {
      apandisit[i].style.color = "black";
    }
  }
}
...
function lakrimasyon(){
  let lakrimasyon = document.getElementsByClassName("lakrimasyon");
  let lakrimasyonCheckbox = document.getElementById("lakrimasyon");
  if(lakrimasyonCheckbox.checked){
    for (var i = 0; i < lakrimasyon.length; i++) {
      lakrimasyon[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < lakrimasyon.length; i++) {
      lakrimasyon[i].style.color = "black";
    }
  }
}
function ekganomalisi(){
  let ekganomalisi = document.getElementsByClassName("ekganomalisi");
  let ekganomalisiCheckbox = document.getElementById("ekganomalisi");
  if(ekganomalisiCheckbox.checked){
    for (var i = 0; i < ekganomalisi.length; i++) {
      ekganomalisi[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < ekganomalisi.length; i++) {
      ekganomalisi[i].style.color = "black";
    }
  }
}
function siyalore(){
  let siyalore = document.getElementsByClassName("siyalore");
  let siyaloreCheckbox = document.getElementById("siyalore");
  if(siyaloreCheckbox.checked){
    for (var i = 0; i < siyalore.length; i++) {
      siyalore[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < siyalore.length; i++) {
      siyalore[i].style.color = "black";
    }
  }
}
function urgency(){
  let urgency = document.getElementsByClassName("urgency");
  let urgencyCheckbox = document.getElementById("urgency");
  if(urgencyCheckbox.checked){
    for (var i = 0; i < urgency.length; i++) {
      urgency[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < urgency.length; i++) {
      urgency[i].style.color = "black";
    }
  }
}
function apne(){
  let apne = document.getElementsByClassName("apne");
  let apneCheckbox = document.getElementById("apne");
  if(apneCheckbox.checked){
    for (var i = 0; i < apne.length; i++) {
      apne[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < apne.length; i++) {
      apne[i].style.color = "black";
    }
  }
}
function beslenmeproblemleri(){
  let beslenmeproblemleri = document.getElementsByClassName("beslenmeproblemleri");
  let beslenmeproblemleriCheckbox = document.getElementById("beslenmeproblemleri");
  if(beslenmeproblemleriCheckbox.checked){
    for (var i = 0; i < beslenmeproblemleri.length; i++) {
      beslenmeproblemleri[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < beslenmeproblemleri.length; i++) {
      beslenmeproblemleri[i].style.color = "black";
    }
  }
}
function reflü(){
  let reflü = document.getElementsByClassName("reflü");
  let reflüCheckbox = document.getElementById("reflü");
  if(reflüCheckbox.checked){
    for (var i = 0; i < reflü.length; i++) {
      reflü[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < reflü.length; i++) {
      reflü[i].style.color = "black";
    }
  }
}
function stridor(){
  let stridor = document.getElementsByClassName("stridor");
  let stridorCheckbox = document.getElementById("stridor");
  if(stridorCheckbox.checked){
    for (var i = 0; i < stridor.length; i++) {
      stridor[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < stridor.length; i++) {
      stridor[i].style.color = "black";
    }
  }
}
...
function balgam(){
  let balgam = document.getElementsByClassName("balgam");
  let balgamCheckbox = document.getElementById("balgam");
  if(balgamCheckbox.checked){
    for (var i = 0; i < balgam.length; i++) {
      balgam[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < balgam.length; i++) {
      balgam[i].style.color = "black";
    }
  }
}
function paslıdil(){
  let paslıdil = document.getElementsByClassName("paslıdil");
  let paslıdilCheckbox = document.getElementById("paslıdil");
  if(paslıdilCheckbox.checked){
    for (var i = 0; i < paslıdil.length; i++) {
      paslıdil[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < paslıdil.length; i++) {
      paslıdil[i].style.color = "black";
    }
  }
}
function nabızdiskordansı(){
  let nabızdiskordansı = document.getElementsByClassName("nabızdiskordansı");
  let nabızdiskordansıCheckbox = document.getElementById("nabızdiskordansı");
  if(nabızdiskordansıCheckbox.checked){
    for (var i = 0; i < nabızdiskordansı.length; i++) {
      nabızdiskordansı[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < nabızdiskordansı.length; i++) {
      nabızdiskordansı[i].style.color = "black";
    }
  }
}
function dikrotiknabız(){
  let dikrotiknabız = document.getElementsByClassName("dikrotiknabız");
  let dikrotiknabızCheckbox = document.getElementById("dikrotiknabız");
  if(dikrotiknabızCheckbox.checked){
    for (var i = 0; i < dikrotiknabız.length; i++) {
      dikrotiknabız[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < dikrotiknabız.length; i++) {
      dikrotiknabız[i].style.color = "black";
    }
  }
}
function rosespots(){
  let rosespots = document.getElementsByClassName("rosespots");
  let rosespotsCheckbox = document.getElementById("rosespots");
  if(rosespotsCheckbox.checked){
    for (var i = 0; i < rosespots.length; i++) {
      rosespots[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < rosespots.length; i++) {
      rosespots[i].style.color = "black";
    }
  }
}
function ral(){
  let ral = document.getElementsByClassName("ral");
  let ralCheckbox = document.getElementById("ral");
  if(ralCheckbox.checked){
    for (var i = 0; i < ral.length; i++) {
      ral[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < ral.length; i++) {
      ral[i].style.color = "black";
    }
  }
}
function likenifikasyon(){
  let likenifikasyon = document.getElementsByClassName("likenifikasyon");
  let likenifikasyonCheckbox = document.getElementById("likenifikasyon");
  if(likenifikasyonCheckbox.checked){
    for (var i = 0; i < likenifikasyon.length; i++) {
      likenifikasyon[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < likenifikasyon.length; i++) {
      likenifikasyon[i].style.color = "black";
    }
  }
}
function skuam(){
  let skuam = document.getElementsByClassName("skuam");
  let skuamCheckbox = document.getElementById("skuam");
  if(skuamCheckbox.checked){
    for (var i = 0; i < skuam.length; i++) {
      skuam[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < skuam.length; i++) {
      skuam[i].style.color = "black";
    }
  }
}
function kötükoku(){
  let kötükoku = document.getElementsByClassName("kötükoku");
  let kötükokuCheckbox = document.getElementById("kötükoku");
  if(kötükokuCheckbox.checked){
    for (var i = 0; i < kötükoku.length; i++) {
      kötükoku[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < kötükoku.length; i++) {
      kötükoku[i].style.color = "black";
    }
  }
}
function impetigo(){
  let impetigo = document.getElementsByClassName("impetigo");
  let impetigoCheckbox = document.getElementById("impetigo");
  if(impetigoCheckbox.checked){
    for (var i = 0; i < impetigo.length; i++) {
      impetigo[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < impetigo.length; i++) {
      impetigo[i].style.color = "black";
    }
  }
}
function papül(){
  let papül = document.getElementsByClassName("papül");
  let papülCheckbox = document.getElementById("papül");
  if(papülCheckbox.checked){
    for (var i = 0; i < papül.length; i++) {
      papül[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < papül.length; i++) {
      papül[i].style.color = "black";
    }
  }
}
function polidipsi(){
...
function vezikül(){
  let vezikül = document.getElementsByClassName("vezikül");
  let vezikülCheckbox = document.getElementById("vezikül");
  if(vezikülCheckbox.checked){
    for (var i = 0; i < vezikül.length; i++) {
      vezikül[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < vezikül.length; i++) {
      vezikül[i].style.color = "black";
    }
  }
}
...
function bulantı(){
  let bulantı = document.getElementsByClassName("bulantı");
  let bulantıCheckbox = document.getElementById("bulantı");
  if(bulantıCheckbox.checked){
    for (var i = 0; i < bulantı.length; i++) {
      bulantı[i].style.color = "maroon";
    }
  }
  else {
    for (var i = 0; i < bulantı.length; i++) {
      bulantı[i].style.color = "black";
    }
  }
}
